...
//DirectedGraph.java : Program for traversing a directed graph through DFS and finding the tree edges.
...
class DirectedGraph
{
    ...
    public void dfsTreeEdges(String vertexName)
    {
        ...
        for(int v=0; v<nVertices; v++)
        {
        	System.out.println("Vertex : " + v + " , Predecessor : " + vertexList[v].predecessor);
        }
        ...
        for(int v=0; v<nVertices; v++)
        {
            ...
            if (vertexList[v].predecessor != -1)
            	System.out.println("Tree Edge - (" + vertexList[u].name + "," + vertexList[v].name + ")");
        }
